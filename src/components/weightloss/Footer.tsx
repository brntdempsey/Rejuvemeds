...
const treatments = ["Weight Loss", "Hormone Optimization", "Sexual Health", "Hair Loss"];
const company = ["Contact", "Support", "Privacy Policy", "Terms of Service"];
const resources = ["Blog", "BMI Calculator", "Learn"];
const legal = ["Terms + Conditions", "Privacy Policy", "Accessibility"];
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 420 }}>
        <Image
          src="/images/dashboard/Rejuve TM.png"
          alt="Rejuve"
          width={200}
          height={60}
          style={{ objectFit: "contain", width: "clamp(140px, 10.4vw, 200px)", height: "auto" }}
        />
        <p
          style={{
      ...
      <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "clamp(30px, 3.1vw, 60px)" }}>
            <div style={{ display: "flex", gap: "clamp(20px, 4.2vw, 80px)", flexWrap: "wrap" as const }}>
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: "clamp(12px, 1.05vw, 20px)" }}>
                  {treatments.map((item) => (
                    <Link
                      key={item}
                      href="#"
                      style={{
                        fontSize: "clamp(13px, 0.78vw, 15px)",
                        color: "white",
                        fontFamily: "'Aeonick Pro', sans-serif",
                        textDecoration: "none",
                      }}
        ...
        <div style={{ display: "flex", gap: "clamp(20px, 4.2vw, 80px)", borderTop: "1px solid grey", paddingTop: 30, flexWrap: "wrap" as const }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 16, marginTop: "clamp(12px, 1.05vw, 20px)" }}>
              <Link href="#" style={{ color: "white", fontSize: 24, textDecoration: "none" }}>
