...
export default function HeroTitle() {
  return (
    ...
    <div className="relative">
      <div>
      <h1 style={{ fontSize: "clamp(14px, 1.05vw, 20px)", fontFamily: "'Aeonick Pro', sans-serif", color: "rgba(0, 0, 0, 0.5)" }} className="font-bold">
        Join Thousands of Rejuve Meds Patients:
      </h1>
      <p style={{ fontSize: "clamp(40px, 3.75vw, 72px)", fontFamily: "'Aeonick Pro', sans-serif", color: "#D3A059", marginTop: 15}} className="font-bold">
        Weight Loss,
      </p>
      <p style={{ fontSize: "clamp(40px, 3.75vw, 72px)", fontFamily: "'Aeonick Pro', sans-serif", color: "black", marginTop: 5}} className="font-bold">
        Tailored to You.
      </p>
      </div>
